\echo attachment
create or replace view achilles.attachment as
  select n.*,
    (n.attributes->>'fooditemid') as fooditemid,
    (n.attributes->>'label') as label,
    (n.attributes->>'description') as description,
    (n.attributes->>'mimetype') as mimetype
  from engine.node as n
  where n.prg='achilles.attachment'
;
